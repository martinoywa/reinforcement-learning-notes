...
- In my experiements, with a Discount Faction (gamma=1), Value Iteration converges immediately, while Policy Iteration struggles. This is because Value Iteration doesn't care about solving the full environment. It just does a single sweep of the states and moves one. Policy Iteration on the other hand, struggles in its Policy Evaluation step because values become large and too hard to stabilise.
- Note that the above may only be true in small discrete environments.