...
* That said, this behaviour may be specific to small, discrete environments. Most references suggest PI should converge in fewer iterations than VI, so this could also be an issue of my iterative implementation.
